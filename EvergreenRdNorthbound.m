...
road.N_lanes(road.x_centers>=3501 & road.x_centers<=4500) = 5;
road.N_lanes(road.x_centers>=4501 & road.x_centers<=5500) = 3;
road.N_lanes(road.x_centers>=5501 & road.x_centers<=6500) = 4;
...
idx_30 = road.x_centers>=1001 & road.x_centers<=3000;% 30 mph segments
